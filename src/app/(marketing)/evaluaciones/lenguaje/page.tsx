...
const config: EvaluacionConfig = {
  ...
  proceso: [
    ...
    },
    {
      ...
      description:
        "Evaluación del lenguaje según la edad y el caso. Si el proceso requiere aplicación presencial, se coordina una jornada en Arica.",
    },
    {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        "Las entrevistas y la devolución son online. Algunas pruebas, según la edad y el caso, requieren aplicación presencial en una jornada en Arica. Escríbeme por WhatsApp antes de reservar y lo conversamos.",
    },
    {
